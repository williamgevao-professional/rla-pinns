...
RUNS = {"gaussian": "gauss_nobound", "path": "path_nobound"}
COLORS = {"gaussian": "tab:orange", "path": "tab:blue"}
...
for label, rid in RUNS.items():
    ...
    print(f"{label:9s}: final l2={hist[label]['l2_error'].iloc[-1]:.3e}, "
...
fig.tight_layout()
fig.savefig("nobound_comparison.png", dpi=200)
print("saved nobound_comparison.png")
