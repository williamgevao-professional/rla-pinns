...
python ../yaml_to_sh.py sweeps/ENGD_pcg.yaml sweeps/ENGD_pcg.sh --qos=m2 --array=50
python ../yaml_to_sh.py sweeps/SPRING_pcg.yaml sweeps/SPRING_pcg.sh --qos=m --array=50
