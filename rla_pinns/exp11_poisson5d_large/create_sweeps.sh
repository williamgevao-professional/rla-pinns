...
python ../yaml_to_sh.py sweeps/ENGD_naive_1k.yaml sweeps/ENGD_naive_1k.sh --qos=m --array=20
# python ../yaml_to_sh.py sweeps/ENGD_naive_5k.yaml sweeps/ENGD_naive_5k.sh --qos=m2 --array=20
# python ../yaml_to_sh.py sweeps/ENGD_naive_10k.yaml sweeps/ENGD_naive_10k.sh --qos=m3 --array=20